#!/usr/bin/env python3
"""
Generate multi-region comparison plots for Kalman Q=0.1, R=0.1 vs raw signal.
Format matches TOP 3 FILTERS multi-region comparison style.
"""
...
KALMAN_CONFIG = {'Q': 0.1, 'R': 0.1, 'label': 'Kalman (Q=0.1, R=0.1)', 'color': '#e74c3c'}
...
def plot_multiregion_comparison(signal_label, channel='acc_z'):
    ...
    # Overall title
    title = f"Kalman Q=0.1, R=0.1 - Multi-Region Comparison\n"
    ...
    # Save
    filename = f"kalman_multiregion_{channel}_{signal_label}.png"
...
def main():
    ...
    print("\n" + "="*80)
    print("KALMAN Q=0.1, R=0.1 - MULTI-REGION COMPARISON")
    print("="*80)
