...
# Submit filter comparison jobs in batches for Account 1
# Filters: Butterworth, Biquad, EMA
# Subjects: 2, 3, 6
...
experiments=(
    "butterworth_40hz_o2:2"
    "butterworth_40hz_o2:3"
    "butterworth_40hz_o2:6"
    "biquad_30hz_q10:2"
    "biquad_30hz_q10:3"
    "biquad_30hz_q10:6"
    "ema_alpha05:2"
...
echo "================================================"
echo "FILTER COMPARISON - ACCOUNT 1 (Batched)"
echo "================================================"
...
echo "  - Butterworth (40Hz, O2)"
echo "  - Biquad (30Hz, Q=1.0)"
echo "  - EMA (α=0.5)"