...
JOB5=$(sbatch --parsable --dependency=afterany:$JOB2 scripts/06_model_compression/run_single_pruning.sh prune_ema_s06_40pct_seed123.json)
JOB6=$(sbatch --parsable --dependency=afterany:$JOB1 scripts/06_model_compression/run_single_pruning.sh prune_ema_s06_40pct_seed456.json)
echo "  40% seeds: $JOB4, $JOB5, $JOB6"

JOB7=$(sbatch --parsable --dependency=afterany:$JOB4 scripts/06_model_compression/run_single_pruning.sh prune_ema_s06_50pct_seed42.json)
JOB8=$(sbatch --parsable --dependency=afterany:$JOB5 scripts/06_model_compression/run_single_pruning.sh prune_ema_s06_50pct_seed123.json)
JOB9=$(sbatch --parsable --dependency=afterany:$JOB6 scripts/06_model_compression/run_single_pruning.sh prune_ema_s06_50pct_seed456.json)
